...
import { getCategories, getProducts, getProductsByHomeSection } from "@/lib/queries";

export default async function HomePage() {
  const [categories, maisVendidos, novidades, ofertas, imagens, tercos] = await Promise.all([
    getCategories(),
